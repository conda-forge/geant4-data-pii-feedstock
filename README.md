...
Once the `conda-forge` channel has been enabled, `geant4-data-pii` can be installed with:

```
conda install geant4-data-pii
```

It is possible to list all of the versions of `geant4-data-pii` available on your platform with:
